...
Relational databases are a database type that stores information in linked tables. SQL is a query language used to interface with these databases.

2. Why do tables need a Primary Key?

Rows need at least one unique identifier to make sure that the correct record is being retrieved.
...
An intermediary table with a one-to-many relationship to the other two tables, detailing individual instances of the connection.
